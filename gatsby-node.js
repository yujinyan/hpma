...
// Create general interfaces that you could use to leverage other data sources
...
// const projectsTemplate = require.resolve(`./src/templates/gallery.tsx`)
// const projectTemplate = require.resolve(`./src/templates/project-query.tsx`)

exports.createPagesBak = async ({ actions, graphql, reporter }, themeOptions) => {
  const { createPage } = actions
